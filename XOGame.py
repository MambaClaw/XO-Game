...
class SpaceGameWindow(arcade.Window):
    ...
    def on_draw(self):
        arcade.start_render()
        self.table00_sprite.set_position(100, 500)
        self.table01_sprite.set_position(100, 300)
        self.table02_sprite.set_position(100, 100)
        self.table10_sprite.set_position(300, 500)
        self.table11_sprite.set_position(300, 300)
        self.table12_sprite.set_position(300, 100)
        self.table20_sprite.set_position(500, 500)
        self.table21_sprite.set_position(500, 300)
        self.table22_sprite.set_position(500, 100)
        ...
        if(Matrix[0][0] == 1):
            self.table00_sprite = arcade.Sprite('images/assets/x.png')
        if(Matrix[0][1] == 1):
        ...
        if(Matrix[0][0] == 2):
            self.table00_sprite = arcade.Sprite('images/assets/o.png')
        if(Matrix[0][1] == 2):
